...
const int __vector_table[] @ ".intvec" = {
	(int)&CSTACK$$Limit,
	(int)&__iar_program_start, //or (int)__iar_program_start
	(int)&NMI_Handler,
	(int)&HardFault_Handler, //eg stack overflow.
...
__stackless void HardFault_Handler(void){
	assert_failed("HardFault", __LINE__); //file name and line number, (in prep macro)
}

__stackless void NMI_Handler(void){
	assert_failed("NMI", __LINE__); //file name and line number, (in prep macro)
}

__stackless void MemManage_Handler(void){
	assert_failed("MemManage", __LINE__); //file name and line number, (in prep macro)
}

__stackless void BusFault_Handler(void){
	assert_failed("BusFault", __LINE__); //file name and line number, (in prep macro)
}

__stackless void UsageFault_Handler(void){
	assert_failed("UsageFault", __LINE__); //file name and line number, (in prep macro)
}

//other handlers - not faults
//can use weak alias to define them
__stackless void Unused_Handler(void){
	assert_failed("Unused", __LINE__); //file name and line number, (in prep macro)
}
